import { assert } from "./game.mjs";
let unflipDelay = window.delayTime;
export function handleGameInput(mouse, state) {
...
export function updateGame(mouse, state, dt) {
...
function updateCursor(mouse, state) {
    mouse.style = "default";
...
function updateSelected(state, dt) {
    if (state.selected.length < 2)
        return;
